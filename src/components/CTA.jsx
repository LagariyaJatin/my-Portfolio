      ...
      <div className="container">
        <div className="cta__panel reveal-up">
          ...
          <div className="cta__actions">
            <a ref={startRef} href="https://wa.me/919913987262?text=Hi%20Jatin!%20I%27d%20like%20to%20discuss%20a%20project." target="_blank" rel="noreferrer" className="btn btn--accent" data-cursor="link">
              Start a Project
            </a>
            <a ref={emailRef} href="mailto:lagariyajatin@gmail.com?subject=Project%20Inquiry" className="btn btn--outline-dark" data-cursor="link">
              Email Me
            </a>
          </div>

          <div className="cta__socials">
            <a href="https://github.com/LagariyaJatin" target="_blank" rel="noreferrer">
            ...
            <a href="https://www.linkedin.com/in/gecrcomp240200107070" target="_blank" rel="noreferrer">
              <svg width="13" height="13" viewBox="0 0 16 16" fill="currentColor" aria-hidden="true">
            ...
            <a href="mailto:lagariyajatin@gmail.com">
